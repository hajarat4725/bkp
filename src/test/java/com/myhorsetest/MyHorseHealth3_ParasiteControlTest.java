...
public class MyHorseHealth3_ParasiteControlTest extends Base {
	...
	MyHorseHealth3_ParasiteControl  HealthAction_parasite = null;
...
Reporter.log("Browser open", true);
		...
		HealthAction_parasite = new MyHorseHealth3_ParasiteControl(driver);	
  ...
  @Test
  public void MyHorseHealth3_ParasiteControl () throws AWTException, InterruptedException {
...
// Object Of My horse listing POM Class
	 ...
	 /*-----------------------------------------------------------------------------------------------------------*/ 
	  ...
	  HealthAction_parasite.ClickMyHorseRe(); 
	  
	  
	  
	 HealthAction_parasite.MyHorseHealth_ParasiteControlAddParasiteControl();
  
	  HealthAction_parasite.MyHorseHealth_ParasiteControlEditParasiteControl();
//	  
	  HealthAction_parasite.MyHorseHealth_ParasiteControlDeletParasiteControl();
